    ...
    return (
      <div>
        <p class="service-info">
          Here, SHRUB can identify your client by some ID that you've provided,
          which is stored in a database. This allows you to add an additional
          check that can do many things, such as check the client's service
          contract for validity or issues, or even pull up the client's known
          hardware configuration which can then be ingested by SHRUB to give
          more targeted answers. In this demo, all the service number does for
          the moment is allow SHRUB to know the name of your client so she can
          greet them properly.
        </p>
